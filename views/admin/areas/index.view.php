        ...
        <table class="table table-striped table-hover align-middle">
            ...
            <tbody>
                <?php foreach ($allAreas as $area) : ?>
                    <?php
                    $id = htmlspecialchars($area['AREAID']);
                    $name = htmlspecialchars($area['AREA_Nombre']);
                    $acronym = htmlspecialchars($area['AREA_Siglas']);
                    ?>
                    <tr>
                        <td><?= $name ?></td>
                        <td><?= $acronym ?></td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="deleteModalLabel<?= $id ?>">Eliminar Área</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p>¿Seguro de que desea eliminar esta área?</p>
                                    </div>
