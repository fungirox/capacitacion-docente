...
<main role="main" class="container py-5" style="margin-top: 56px">
    ...
    <form class="row pt-4 g-2 justify-content-between" method="GET">
                ...
                <div class="col-md-6">
                    <div class="input-group flex-nowrap">
                        ...
                        <input
                            ...
                            id="search"
                            class="form-control"
                            placeholder="Buscar instructore..."
                            aria-label="BuscarInstructor"
                            aria-describedby="buscar-instructor"
        ...
        <?php if (!$archivados): ?>
            <div class="col-12 col-md-auto">
                <div class="d-grid">
                    <a href="instructores/nuevo" type="button" class="btn btn-primary">
    ...
    <div class="row row-cols-auto justify-content-between py-3 px-2">
        <?php if ($paramsActive): ?>
            <a class="col" href="<?= $archivados ? "?archivados=true" : "/admin/instructores" ?>">
        ...
        <span class="col text-secondary text-end fst-italic">
            <?= $pagination["totalItems"] ?> <?= $pagination["totalItems"] == 1 ? "instructor encontrado" : "instructores encontrados" ?>
        </span>
    </div>
    <?php if (empty($allInstructores)): ?>
    ...
    <?php else: ?>
        <div class="table-responsive">
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    <?php foreach ($allInstructores as $instructor) : ?>
                        <?php
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="archiveModalLabel<?= $id ?>"><?= $archivados ? "Desarchivar" : "Archivar" ?> Instructor</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <p>¿Seguro de que desea <?= $archivados ? "desarchivar" : "archivar" ?> este instructor?</p>
                                        </div>
    ...
    <div class="d-flex flex-column align-items-center gap-3 pt-3">
        <span class="text-center text-secondary">¿No encuentras el instructor que buscas?</span>
        <a href="<?= $archivados ? "/admin/instructores" : "?archivados=true" ?>" type="btn" class="btn btn-outline-secondary">
            <?= $archivados ? "Ver instructores activos" : "Ver instructores archivados" ?>
        </a>
    </div>
</main>
