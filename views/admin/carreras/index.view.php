...
<main role="main" class="container py-5" style="margin-top: 56px">
    ...
    <?php else: ?>
        <div class="table-responsive">
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    <?php foreach ($allCarreras as $career) : ?>
                        <?php
                        $id = $career['id'];
                        $name = htmlspecialchars($career['nombre']);
                        $siglas = htmlspecialchars($career['siglas']);
                        ?>
                        <tr>
                            <td><?= $name ?></td>
                            <td><?= $siglas ?></td>
    ...
    <div class="d-flex flex-column align-items-center gap-3 pt-3">
        ...
        <a href="<?= $archivados ? "/admin/carreras" : "?archivados" ?>" type="btn" class="btn btn-outline-secondary">
