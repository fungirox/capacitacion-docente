...
<?php if ($_SESSION["user"]["rol"] === Roles::DOCENTE_INSTRUCTOR || $_SESSION["user"]["rol"] === Roles::DOCENTE): ?>
    <li class="nav-item">
...
<?php endif; ?>
<?php if ($_SESSION["user"]["rol"] === Roles::DOCENTE_INSTRUCTOR || $_SESSION["user"]["rol"] === Roles::INSTRUCTOR): ?>
    <li class="nav-item">
